...
// Префіксна форма ++i:
let ii = 0;
while (++ii < 5) console.log( ii ); //1, 2, 3, 4

//Постфіксна форма i++

let digit1: number = 0;
while (digit1++ < 5) console.log( digit1 ); //1,2,3,4,5
...
//Постфіксна форма:
for (let i: number = 0; i < 5; i++) console.log( i ); //0,1,2,3,4
...
//можна відразу почати з парних чисел та додавати до них 2 на кожній ітерації
...
let typedNumber: number = 10; // Задаємо значення кінця діапазону чисел

for (let i:number = 2; i <= typedNumber; i++) {
